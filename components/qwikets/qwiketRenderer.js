...
const QwiketRenderer = ({
    ...
    const linkColor = palette.linkColor;
    ...
    if (!author) author = "";
    if (!site_name) site_name = "SITENAME";
    ...
    if (!image) image = image_src;
    let sharedBy =
        d.sharedBy && d.sharedBy != "Hudson Wilde" && d.sharedBy != "- Q -"
            ? d.sharedBy
            : null;
    ...
    /*  const lapsed = timestamp
            ? u.timeConverter(
                  timestamp,
                  typeof window !== "undefined" && window.virgin
    ...
    let rs =
        !reshare || reshare == 100 || reshare == 50
            ? 0
            : reshare == 6 || reshare == 106 || reshare == 56
            ? 6
            : reshare == 7 || reshare == 107 || reshare == 57
            ? 7
            : reshare == 9 || reshare == 59 || reshare == 109
            ? 9
            : -1;
    let isVideo = false;
            ...
            case "rich-link": {
                ...
                if (m) {
                    ...
                    /*html = <div style={{ width: '100%', padding: 8 }}>
                            ...
                            /> */
                    return (
                        <div className="q-qwiket-rich-link">
                            <QwiketRenderer
                                full={false}
                    ...
                    <div
                        ...
                        <div
                            ...
                            <img
                                ...
                                src={cdn(d.authorAvatar)}
                            />

                            <div className="q-qwiket-author-small">
                                {author}
                            </div>
                        </div>
                        <div style={{ display: "flex" }}>
                            {lapsed ? (
                                <div className="q-qwiket-lapsed">{lapsed}</div>
                            ) : null}
                        </div>
                    </div>
                );
                ...
                header = (
                    <div>
                        <div
                            ...
                            <div style={{ display: "flex" }}>
                                {lapsed && !d.topLevel ? (
                                    <span className="q-qwiket-lapsed">
                                        {lapsed}
                                    </span>
                                ) : null}
                        ...
                        {!full && top ? <span>{d.title}</span> : null}
                    </div>
                );
                break;
            default:
                const HeaderWrap = styled.div``;
                const TopHeaderLine = styled.div`
                    width: 100%;
                    display: flex;
                    flex-direction: row;
                ...
                const LeftTop = styled.div`
                    ...
                    flex-direction: row;
                    align-items: center;
                    margin-bottom: ${reshare == 2 ? "-12" : "10"}px;
                    opacity: ${reshare == 3 ? 0.8 : 1.0};
                `;
                const TagImage = styled.img`
                    width: 32px;
                    height: 32px;
                    margin-top: ${reshare == 2 ? "12" : "4"}px;
                    margin-bottom: ${reshare == 2 ? "12" : "4"}px;
                    margin-right: 6px;
                `;
                const Sitename = styled.div``;
                const Lapsed = styled.div`
                    font-size: 0.6rem;
                `;
                const SecondHeaderLine = styled.div`
                    width: 100%;
                    opacity: ${reshare == 3 ? 0.8 : 1.0};
                `;
                ...
                header = (
                    <HeaderWrap>
                        <TopHeaderLine>
                            <LeftTop>
                                {showTagImage ? (
                                    <TagImage src={tagImage}></TagImage>
                                ) : null}
                                <Sitename>
                                    {reshare != 2 ? "@" + site_name : author}
                                </Sitename>
                            </LeftTop>
                            {showLapsed ? <Lapsed>{lapsed}</Lapsed> : null}
                        </TopHeaderLine>
                        {reshare != 2 && author ? (
                            <SecondHeaderLine>{author}</SecondHeaderLine>
                        ) : null}
                        {reshare != 2 ? <Title>{d.title}</Title> : null}
                    </HeaderWrap>
                );
        }
    }
...
{approver || (loud && !d.topLevel) ? approver ? <QwiketMenu qwiketid={d.threadid} updateOnlineState={updateOnlineState} reshare={d.reshare} history={history} icon={<img data-id="009" style={{ marginRight: 8, marginTop: 0, opacity: inShow ? 1.0 : 0.7 }} height={24} src={u.cdn(d.indicatorIcon)} />} stickie={d.stickie} editLink={editLink} un={un} /> : <img data-id="004" style={{ marginRight: 2, opacity: inShow ? 0.5 : 0.4 }} height={24} src={u.cdn(d.indicatorIcon)} /> : null}
    ...
    return (
        <StyledDiv
            ...
            {header}
            <Blocks data-id={`d1-${type}`}>{blocks}</Blocks>

            <div>
                {body && body.blocks && full && !readMore ? (
                    <div
                        data-id="oolong-short"
                        className="q-qwiket-rollup"
                        onClick={() => setLong(!readMore)}>
                        Show More
                        <ChevronDown style={{ height: 28, width: 28 }} />
                    </div>
                ) : null}
                {full && readMore ? (
                    <div
                        ...
                        onClick={() => setLong(!readMore)}>
                        Show Less
                        <ChevronUp style={{ height: 28, width: 28 }} />{" "}
                    </div>
                ) : null}
                <div style={{ width: "100%" }}>
                    {" "}
                    {full && (reshare == 0 || reshare == 100) ? (
                        <div
                            className=".q-qwiket-aaaa-wrap"
                            style={{
                                display: "flex",
                                marginBottom: 20,
                                width: "100%",
                ...
                {!full && opened && top && subtype == "parent" ? (
                    <div
                        data-id="blank-1"
                        style={{
                            height: 20,
                            marginTop: 10,
                            borderTop: "dotted thin green",
                            opacity: 0.4,
                        }}
                    />
                ) : null}
...
export default withTheme(QwiketRenderer);
