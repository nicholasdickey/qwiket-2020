...
const StyledCheckbox = styled(({ ...other }) => (
    <div classes={{ checked: "checked", disabled: "disabled" }} {...other} />
))`
  color: #eee !important;
  width:200px%;
  & .label {
...
let Topic = ({ theme, qparams, channel, context, session, actions }) => {
    ...
    if (qparams.hub) qwiketid = `${qparams.hub}-slug-${qwiketid}`;
    if (qwiketid != topicid) {
    ...
    var ch =
        channel && channel != "usconservative" && channel != "qwiket"
            ? "/channel/" + channel
            : "";
        ...
        <OuterTopic>
                    ...
                    <div className="q-comments">
                        <div
                            ...
                            <img
                                height={24}
                                src={
                                    "https://c.disquscdn.com/next/c393ff4/marketing/assets/img/brand/disqus-social-icon-blue-white.svg"
                                }
                            />
                            ...
                            skip={
                                topic
                                    ? topic.get("description") ==
                                      "Please wait, it could take a minute or two to put the report together for you..."
                                    : true
                            }
                            threadid={qwiketid}
            ...
            <div
                ...
                <img
                    ...
                    src="/static/css/qwiket-logo.png"
                />
            </div>
        </OuterTopic>
    );
...
Topic = withTheme(Topic);

Context = withTheme(Context);
