...
const LoginDialog = ({
    ...
    if (
        ...
        setLoading(1);
    else if (Root.__CLIENT__ && window.location.href.indexOf("xcode") < 0)
        setLoading(0);
                        ...
                        <div className="q-wg-login-buttons">
                            <Button
                                ...
                                onClick={async () => {
                                    ...
                                    window.location =
                                        "/disqus-login"; /*window.location = window.location.href.indexOf(' ? ') >= 0 ? window.location.href + ' & login=1' : window.location.href + '?login=1' */
                                }}>
                                Disqus Login
                            </Button>
