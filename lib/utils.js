...
const utils = {
    ...
    parseQwiketid(topic) {
        ...
        let category = topic.tags.split(",")[0];
        //  console.log("parseQwiketid:", { tthreadid, category });
        // if (!category && topic.tags) category = topic.tags[0];
        if (thub)
            return {
                qwiketid: tthreadid,
                hub: thub,
    ...
    getLayoutWidth({ width }) {
        // console.log("getLayoutWidth", { width });
