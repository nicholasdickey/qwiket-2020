...
import { refresh } from "./qwiketRouter";
export function getColumnsMap() {
    return {
        w900: {
            normal: 4,
            thick: 4,
...
export function changeUserLayout({
    ...
    console.log("changeUserLayout2:", {
        userLayout0: userLayout,
        userLayout: ui2,
        pageType,
        layoutNumber,
        res,
    ...
    if (!userLayout.layout[pageType][layoutNumber][res][density]) {
        console.log("userLayout 222:", userLayout, chanConfig);
...
export function parseLayout({ qparams, qstate }) {
    ...
    if (typeof channelLayout === "string") {
        ...
        //   console.log("parse channelLayout", channelLayout);
    }
